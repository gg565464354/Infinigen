...
from flexgen.cache_selection_controller import CacheManager
import json
import sys
...
#         # 保存 profile
#         prof.export_chrome_trace(f'/root/sparse-load/SparseCache/speedup/profile_mycache_gpu_b{args.gpu_batch_size}_i{prompt_len}_o{gen_len}.json')
